...
public class MagentoProductMediaManager extends MagentoHttpComponent {
	...
	public long uploadProductImage(String sku, int position, String filename, String base64EncodedData,
	...
	public long uploadImage(String sku, String imageFilePath, boolean forceOverwrite) {
		String extension = imageFilePath.substring(imageFilePath.lastIndexOf('.')).toLowerCase();
		ImageType imageType = ImageTypes.get(extension);
	...
	public boolean updateProductImage(String sku, long entryId, int position, String filename, byte[] imageBytes,
			String imageType, String imageFileName) {
	...
	public boolean updateProductImage(String sku, long entryId, int position, String filename, String base64EncodedData,
			String imageType, String imageFileName) {
