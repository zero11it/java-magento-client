...
public class AttributeValueDeserializer implements ObjectDeserializer {
	...
	/*
	 * @Override public void write(JSONSerializer serializer, Object object, Object
	 * fieldName, Type fieldType, int features) throws IOException { Integer value =
	 * (Integer) object; String text = value + "元"; serializer.write(text); }
	 */
